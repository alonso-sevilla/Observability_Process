...
CREATE OR REPLACE PROCEDURE OBSERVABILITY_SETUP.SETUP_PROCEDURES_V1.EMAIL_LAST_RESULTS("SEND_TO1" VARCHAR(16777216), "SEND_TO2" VARCHAR(16777216), "SUBJECT" VARCHAR(16777216))
...
def x(session, send_to1, send_to2, subject):
  ...
  session.call(''system$send_email'', ''alert_infra'', f''{send_to1}, {send_to2}'', subject, body)
  return ''email sent:\\n%s'' % body
';