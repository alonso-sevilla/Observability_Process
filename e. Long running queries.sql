      ...
      IF( EXISTS(
        ...
        SELECT CURRENT_ACCOUNT() AS ACCOUNT,
          ...
          IFF(((QH.WAREHOUSE_SIZE = 'X-Small' 
            ...
            OR QH.WAREHOUSE_SIZE = 'X-Large') and EXECUTION_TIME > 1800000),1,0) XL_FLAG,
          IFF(((QH.WAREHOUSE_SIZE = '2X-Large'
            OR QH.WAREHOUSE_SIZE = '3X-Large') and EXECUTION_TIME > 1800000), 1, 0) THREEXL_FLAG,
          IFF((QH.WAREHOUSE_SIZE = '4X-Large' and EXECUTION_TIME > 1800000), 1,0) FOURXL_FLAG
